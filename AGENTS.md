...
**Read [docs/PLAN.md](docs/PLAN.md) first** — it carries the full design and the reasoning
behind every decision below. **Log what you do in [docs/PROGRESS.md](docs/PROGRESS.md)**,
especially things you tried that did *not* work.
